...
where sexo='F' and altura>1,70000 and cabello='Pelirrojo' as Chicas
where sexo='M' and cabello='Castaño' and localidad='Madrid'as Chicos

select count(id), localidad, cabello from contactos
...
select nombre, apellidos from contactos
where (sexo='F' and altura>1.70 and cabello='Pelirrojo')
USE bd1;
